...
public class FindUserActivity extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager mGetUserListLayoutManager;
    ...
    private void initializeRecyclerView() {
        ...
        mGetUserListLayoutManager = new LinearLayoutManager(getApplicationContext(), LinearLayout.VERTICAL , false );
        mUserList.setLayoutManager(mGetUserListLayoutManager);
